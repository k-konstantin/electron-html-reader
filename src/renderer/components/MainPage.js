        ...
        return (
            <div className='page'>
                    ...
                    {isFetching ? (
                        ...
                        animations.map((path, index) => (
                            <div 
                                key={path}
                                title={path}
                                className={index === selectedId ? 'btn selected' : 'btn'}
                ...
                <div className='content-container'>
                    <div className='content-title' title={animations[selectedId]}>{animations[selectedId] && animations[selectedId].slice(-50) || 'Untitled'}</div>
                    <div ref={this.iframeContainerRef} className='iframe-container'>
                        <iframe 
                            src={animations[selectedId]}
                            style={this.state}
                        />
                    </div>
                </div>
